...
const faqList = [
  ...
  { question: '数据会丢失吗？', answer: '账目数据保存在服务器数据库中，清除浏览器缓存或更换设备都不会丢失，重新登录账号即可恢复。服务器每天自动备份，但仍建议定期用"导出数据"自行留存一份。' },
  { question: '如何导出数据？', answer: '进入"我的" → "数据管理" → "导出数据"，即可将所有记录导出为JSON文件。' },
  { question: '忘记密码怎么办？', answer: '在登录页点击"忘记密码"，可通过密保问题或恢复码重置。建议提前在"我的" → "账号安全"中设置密保并生成恢复码，两者都不设的话一旦登出将无法找回。' },
