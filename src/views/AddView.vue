...
onMounted(async () => {
  ...
  if (router.currentRoute.value.params.id) {
    editId.value = router.currentRoute.value.params.id as string
...
<template>
  <div :class="isDesktop ? 'desktop-view flex justify-center' : 'min-h-screen bg-background max-w-[480px] mx-auto px-5 pt-4'">
    <div :class="isDesktop ? 'w-full max-w-[600px]' : ''">
      <!-- Header -->
